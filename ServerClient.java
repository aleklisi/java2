...
public class ServerClient extends Thread {
					...
					if (new File(fileName).isFile()) {
						...
						sendResponse(
								...
								"<b>The Requested resource not found ...."
										+ "Usage: http://127.0.0.1:3012 or http://127.0.0.1:3012/</b>",
								false);
					}
				}
			} else
	...
	public void sendResponse(int statusCode, String responseString,
		...
		if (isFile) {
			...
			responseString = ServerClient.HTML_START + responseString
					+ ServerClient.HTML_END;
	...
	public static void main(String args[]) throws Exception {
		...
		ServerSocket server = new ServerSocket(3012, 10,
				InetAddress.getByName("127.0.0.1"));
		// it works
		// ServerSocket Server = new ServerSocket(5001);
		System.out.println("TCPServer Waiting for client on port 3012");
